...
##*This document was written in R MarkDown and knitted using the 'knit' function to create a pdf. I regularly saved and updated the file data to GitHub using the Commit and Push commands in Rserver.* 
...
brentwood_covid_development$percentage[is.infinite(brentwood_covid_development$percentage)] <- NaN
...
pop_covid_data<-
  ...
  colnames(pop_covid_data) = c("specimen_date", "area_name", "newCases", "cumCases", "area_code", "population")
...
colnames(essex_covid_pop) = c("specimen_date", "area_name", "newCases", "cumCases", "area_code", "population", "percent_pop_infected")
